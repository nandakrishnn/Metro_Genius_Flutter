...
class ChatScreenEmploye extends StatelessWidget {
  final String userId;
  final String workerId;
  String? chatId;

  ChatScreenEmploye({super.key, required this.userId, required this.workerId});
          ...
          if (state is ChatLoading) {
            ...
            return Scaffold(
              ...
              body: Column(
                children: [
                  Expanded(
                    child: MessageList(messages: state.messages, workerId: workerId),
                  ),
...
class MessageList extends StatefulWidget {
  ...
  const MessageList({required this.messages, required this.workerId});
...
class _MessageListState extends State<MessageList> {
  ...
  Widget build(BuildContext context) {
     if(widget.messages.isEmpty){
      return Center(child: Text('Start a Conversion\nMake it Respectful :)'),);
    }
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        final isWorkerMessage = message['senderId'] == widget.workerId;
          ...
          children: [
            Padding(
              ...
              child: Container(
                ...
                child: Column(
                  crossAxisAlignment: isWorkerMessage ? CrossAxisAlignment.start : CrossAxisAlignment.end,
                  children: [
                    Text(
