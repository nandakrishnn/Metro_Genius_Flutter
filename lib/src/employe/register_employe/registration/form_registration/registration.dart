...
GestureDetector EmployeRegistrationForm(
                ...
                child: Column(
                  children: [
                        ...
                        showBottomSheet(
                            ...
                            builder: (context) {
                              ...
                              return BlocBuilder<GetCategoryBloc,
                                  GetCategoryState>(builder: (context, state) {
                    ...
                    CustomTextFeild2(
                        ...
                        validator: (value) =>
                            Validators.validateYearsOfExperience(value)),
                    AppConstants.kheight20,
                    CustomTextFeild2(
                      readOnly: true,
                    ...
                    GestureDetector(
                        onTap: () async {
                          if (formkey.currentState!.validate()) {
                            ...
                            imageDownloadUrl =
                                await uploadImageToFirebase(File(profileimg!));
                            ...
                            context
                                ...
                                .add(FormSubmit());
                            ScaffoldMessenger.of(context).showSnackBar(
                                customSnack('Sucess', ' Details Submitted',
